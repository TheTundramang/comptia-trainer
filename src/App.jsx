...
const SK="netplus-v2";
const HOW_TO_USE="Work through each Domain in order as you finish Professor Messer's videos. Use Flashcards anytime — great for quick review or studying with a partner. After all 5 domains, the Full Practice Test unlocks. Target 80%+ before exam day.";
  ...
  return(
    ...
    <div style={S.wrap}>
      ...
      <div style={{marginTop:20,padding:"12px 16px",border:`1px solid ${C.border}`,borderRadius:8,fontSize:11,color:C.dim,lineHeight:1.8}}>
        <span style={{color:C.d1}}>HOW TO USE: </span>{HOW_TO_USE}
      </div>
    </div></div>
  );
}
